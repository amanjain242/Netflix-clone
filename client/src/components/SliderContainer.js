...
const SliderContainer = ({movies}) => {
  ...
  return (
    <SliderWrapper>
        ...
        <MovieSlider  data ={getMoviesBetween(10,20)} title="New Releases"/>
        ...
        <MovieSlider  data ={getMoviesBetween(50,60)} title="Must Watch"/>
        <MovieSlider  data ={getMoviesBetween(60,70)} title="Most Popular"/>
    </SliderWrapper>
  )
}
